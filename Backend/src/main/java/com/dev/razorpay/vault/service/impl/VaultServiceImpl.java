package com.dev.razorpay.vault.service.impl;
...
import com.dev.razorpay.vault.config.VaultEncryptionConfig;
import com.dev.razorpay.vault.dto.request.TokenizeRequest;
import com.dev.razorpay.vault.dto.response.TokenizeResponse;
import com.dev.razorpay.vault.entity.CardToken;
import com.dev.razorpay.vault.entity.VaultCard;
import com.dev.razorpay.vault.repository.CardTokenRepository;
import com.dev.razorpay.vault.repository.VaultCardRepository;
...
public class VaultServiceImpl implements VaultService {
    ...
    public TokenizeResponse tokenize(TokenizeRequest request, UUID merchantId) {
        ...
        return new TokenizeResponse(token, lastFour, cardBrand, request.expiryMonth(), request.expiryYear(), request.cardHolderName());
    }
